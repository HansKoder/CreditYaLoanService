...
public class SQSSenderReportConfig {
    ...
    @Bean("reportSqsClient")
    public SqsAsyncClient configNotificationSqs(SQSSenderReportProperties properties, MetricPublisher publisher) {
    ...
    private URI resolveEndpoint(SQSSenderReportProperties properties) {
