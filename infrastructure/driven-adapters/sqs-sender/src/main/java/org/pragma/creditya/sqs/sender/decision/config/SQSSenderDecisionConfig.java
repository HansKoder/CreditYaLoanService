...
@Configuration
public class SQSSenderDecisionConfig {

    @Bean("decisionSqsClient")
    public SqsAsyncClient configDecisionSqs(SQSSenderDecisionProperties properties, MetricPublisher publisher) {
    ...
    private URI resolveEndpoint(SQSSenderDecisionProperties properties) {
